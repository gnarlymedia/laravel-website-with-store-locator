...
# Set up the database
echo "CREATE DATABASE IF NOT EXISTS capradtestgrunt" | mysql
echo "drop user 'capradtestgrunt'@'localhost'" | mysql
echo "flush privileges" | mysql
echo "CREATE USER 'capradtestgrunt'@'localhost' IDENTIFIED BY 'BUhnZN6UB8Phjh2K'" | mysql
echo "GRANT ALL PRIVILEGES ON capradtestgrunt.* TO 'capradtestgrunt'@'localhost' IDENTIFIED BY 'BUhnZN6UB8Phjh2K'" | mysql
