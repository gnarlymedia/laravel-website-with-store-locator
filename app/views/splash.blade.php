...
@section('content')
	<div id="patients_referrers" class="row">
		...
		<a href="/mockup-referrer"><img src="/assets/images/buttons/referrer_info_larger.png" alt="referrer_info" width="353" height="77" id="referrer_button" class="img-responsive" /></a>
		<div id="right"></div>
		<a href="/mockup-patients"><img src="/assets/images/buttons/patient_info_larger.png" alt="patient_info" width="353" height="77" id="patient_button" class="img-responsive"/></a>
	</div>
