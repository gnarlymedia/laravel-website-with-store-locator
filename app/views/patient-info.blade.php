...
@section('nav')
	<li><a href="#" class="shadowed">PATIENT INFORMATION</a><div id="pointer" class="hidden-xs"><img src="/assets/images/elements/glyphicon.png" alt="glyphicon" width="31" height="31">
        </div></li>
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            <li class="fadeover"><a href="bone-densitometry">BONE DENSITOMETRY</a></li>
